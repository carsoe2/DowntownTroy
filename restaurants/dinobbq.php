...
<body>
    ...
    <section class="pt-5 pb-5">
        <div class="card mb-3" style="max-height: 500px;">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="../resources/TroyPhotos/dinosaurbbq.png" class="img-fluid rounded-start" alt="Dino BBQ" style="max-height: 440px;">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title"> Dinosaur Bar-B-Que</h5>
                        <p class="card-text">The Dino has been one of the Troy, NY top restaurants serving BBQ since
                            November 2010. We have free parking for all of our guests. The Troy location offers Offsite
                            catering, along with pick up, delivery, drop off with servers and full service.</p>
                        <p class="card-text"><a href="https://www.dinosaurbarbque.com/troy/">Restaurant site</a></p>
                        <div id="mapDBBQ"></div>
                        <p class="card-text">Price level: $$</p>
                        <p class="card-text"><small class="text-muted">BBQ</small></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="Reviews">
        ...
        <form class="Reviews" action="./dinobbq.php" method="POST">
        <div class="form-group">
            <label for="restaurant_name" class="label">Restaurant Name</label>
            <input type="text" readonly class="form-control-plaintext" name="restaurant_name" id="restaurant_name" value="Dinosaur Bar-B-Que">
            </div>
        </div>
         <div class="form-group">
        ...
        <section class="pb-5">
            <div class="container overflow-hidden border rounded greencolor">
                ...
                <?php
                $reviewquery = $conn->prepare("SELECT * FROM `reviews` WHERE `restaurant_name` = 'Dinosaur Bar-B-Que' ORDER BY `rating` DESC; ");
                $reviewquery->execute();
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB7LZwsmPx-r7xMcX9aXais7oCBSgPIHEY&callback=initMapDDBQ&v=weekly" defer></script>
</body>
