...
<?php include("restuarantnavbar.php")?>
    ...
    <section class="pt-5 pb-5">
        <div class="card mb-3" style="max-height: 500px;">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="../resources/TroyPhotos/snowman.png" class="img-fluid rounded-start" alt="Snowman" style="max-height: 440px;">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title">Snowman</h5>
                        <p class="card-text">Since the early 1950's The Snowman has produced all of the premium hard ice cream, yogurts, and sherbets we serve to you on premises daily.</p>
                        <p class="card-text"><a href="http://thesnowmanicecream.com/">Restaurant site</a></p>
                        <div id="snowMap"></div>

                        <p class="card-text">Price level: $</p>
                        <p class="card-text"><small class="text-muted">Ice Cream</small></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="Reviews">
        ...
        <form class="Reviews" action="./Snowman.php" method="POST">
        <div class="form-group">
            <label for="restaurant_name" class="label">Restaurant Name</label>
            <input type="text" readonly class="form-control-plaintext" name="restaurant_name" id="restaurant_name" value="Snowman">
            </div>
        </div>
         <div class="form-group">
        ...
        <section class="pb-5">
            <div class="container overflow-hidden border rounded greencolor">
                ...
                <?php
                $reviewquery = $conn->prepare("SELECT * FROM `reviews` WHERE `restaurant_name` = 'Snowman' ORDER BY `rating` DESC ");
                $reviewquery->execute();
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB7LZwsmPx-r7xMcX9aXais7oCBSgPIHEY&callback=initMapSnowman&v=weekly" defer></script>
</body>
