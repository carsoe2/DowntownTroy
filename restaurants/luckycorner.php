...
<body>
    ...
    <section class="pt-5 pb-5">
        <div class="card mb-3" style="max-height: 500px;">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="../resources/TroyPhotos/luckycorner.png" class="img-fluid rounded-start" alt="Lucky Corner" style="max-height: 440px;">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title"> Lucky Corner</h5>
                        <p class="card-text">This restaurant offers you nice food and a place to rest after a long walk
                            around Rensselaer County Historical Society. Make a change from your habitual meal and taste
                            good pork chops, sesame chicken and pork stew at this place. You will be offered such food
                            as tasty pudding, don't hesitate to try it. Order great bubble tea, americano or milk tea,
                            it's a must when visiting this spot.</p>
                        <p class="card-text"><a href="https://www.yelp.com/biz/lucky-corner-troy">Restaurant site</a>
                        </p>
                        <div id="mapLC"></div>
                        <p class="card-text">Price level: $</p>
                        <p class="card-text"><small class="text-muted">Chinese, Taiwanese</small></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="Reviews">
        ...
        <form class="Reviews" action="./luckycorner.php" method="POST">
        <div class="form-group">
            <label for="restaurant_name" class="label">Restaurant Name</label>
            <input type="text" readonly class="form-control-plaintext" name="restaurant_name" id="restaurant_name" value="Lucky Corner">
            </div>
        </div>
         <div class="form-group">
        ...
        <section class="pb-5">
            <div class="container overflow-hidden border rounded greencolor">
                ...
                <?php
                $reviewquery = $conn->prepare("SELECT * FROM `reviews` WHERE `restaurant_name` = 'Lucky Corner' ORDER BY `rating` DESC");
                $reviewquery->execute();
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB7LZwsmPx-r7xMcX9aXais7oCBSgPIHEY&callback=initMapLC&v=weekly" defer></script>
</body>
