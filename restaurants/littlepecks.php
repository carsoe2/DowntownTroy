...
<body>
    ...
    <section class="pt-5 pb-5">
        <div class="card mb-3" style="max-height: 500px;">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="../resources/TroyPhotos/littlepecks.png" class="img-fluid rounded-start" alt="Little Pecks" style="max-height: 440px;">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title"> Little Pecks</h5>
                        <p class="card-text">Little Pecks is a neighborhood all-day café with a passion for tasty bites
                            and quality beans. We're also the perfect place to meet up with friends, take care of
                            business, or just kick back and relax!</p>
                        <p class="card-text"><a href="https://www.littlepecks.com/">Restaurant site</a></p>
                        <div id="mapLP"></div>
                        <p class="card-text">Price level: $$$</p>
                        <p class="card-text"><small class="text-muted">American, Cafe, Italian</small></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="Reviews">
        ...
        <form class="Reviews" action="./littlepecks.php" method="POST">
        <div class="form-group">
            <label for="restaurant_name" class="label">Restaurant Name</label>
            <input type="text" readonly class="form-control-plaintext" name="restaurant_name" id="restaurant_name" value="Little Pecks">
            </div>
        </div>
         <div class="form-group">
        ...
        <section class="pb-5">
            <div class="container overflow-hidden border rounded greencolor">
                ...
                <?php
                $reviewquery = $conn->prepare("SELECT * FROM `reviews` WHERE `restaurant_name` = 'Little Pecks' ORDER BY `rating` DESC");
                $reviewquery->execute();
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB7LZwsmPx-r7xMcX9aXais7oCBSgPIHEY&callback=initMapLP&v=weekly" defer></script>
</body>
