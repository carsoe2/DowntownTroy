...
<?php include("restuarantnavbar.php")?>
    ...
    <section class="pt-5 pb-5">
        <div class="card mb-3" style="max-height: 500px;">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="../resources/TroyPhotos/slidingdirty.png" class="img-fluid rounded-start" alt="Sliding Dirty" style="max-height: 440px;">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title">Sliding Dirty</h5>
                        <p class="card-text">Slidin’ Dirty has been serving the greater capital region of New York with
                            a unique slider menu since 2012. Our upscale restaurant has a wide variety of delicious
                            food, including vegan options, salads, and macs. We also offer food truck and catering
                            services for all special occasions</p>
                        <p class="card-text"><a href="http://slidindirty.com/">Restaurant site</a></p>

                        <div id="mapSD"></div>
                        <p class="card-text">Price level: $</p>
                        <p class="card-text"><small class="text-muted">Street Food, American, Bar</small></p>
    ...
    <section class="Reviews">
        ...
        <form class="Reviews" action="./slidindirty.php" method="POST">
        <div class="form-group">
            <label for="restaurant_name" class="label">Restaurant Name</label>
            <input type="text" readonly class="form-control-plaintext" name="restaurant_name" id="restaurant_name" value="Sliding Dirty">
            </div>
        </div>
         <div class="form-group">
        ...
        <section class="pb-5">
            <div class="container overflow-hidden border rounded greencolor">
                ...
                <?php
                $reviewquery = $conn->prepare("SELECT * FROM `reviews` WHERE `restaurant_name` = 'Sliding Dirty' ORDER BY `rating` DESC ");
                $reviewquery->execute();
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB7LZwsmPx-r7xMcX9aXais7oCBSgPIHEY&callback=initMapSD&v=weekly" defer></script>
