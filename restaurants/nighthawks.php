...
<body>
    ...
    <section class="pt-5 pb-5">
        <div class="card mb-3" style="max-height: 500px;">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="../resources/TroyPhotos/nighthawks.png" class="img-fluid rounded-start" alt="nighthawks" style="max-height: 440px;">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title">Nighthawks</h5>
                        <p class="card-text">Nighthawks in Troy sources locally grown produce and farm raised meats to create their small but mighty menu. Each dish is prepared with the freshest of ingredients from local farms in Troy, Albany, and surrounding areas. You'll taste the farm to table freshness in every bite! Our goal is to feed our friends and community with the best quality ingredients, cooked nicely, having good food and a good time.</p>
                        <p class="card-text"><a href="https://www.nighthawkstroy.com/fullmenu">Restaurant site</a></p>
                        <div id="mapNH"></div>
                        <p class="card-text">Price level: $$</p>
                        <p class="card-text"><small class="text-muted">American, Bar</small></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="Reviews">
        ...
        <form class="Reviews" action="./nighthawks.php" method="POST">
        <div class="form-group">
            <label for="restaurant_name" class="label">Restaurant Name</label>
            <input type="text" readonly class="form-control-plaintext" name="restaurant_name" id="restaurant_name" value="Nighthawks">
            </div>
        </div>
         <div class="form-group">
        ...
        <section class="pb-5">
            <div class="container overflow-hidden border rounded greencolor">
                ...
                <?php
                $reviewquery = $conn->prepare("SELECT * FROM `reviews` WHERE `restaurant_name` = 'Nighthawks' ORDER BY `rating` DESC");
                $reviewquery->execute();
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB7LZwsmPx-r7xMcX9aXais7oCBSgPIHEY&callback=initMapNH&v=weekly" defer></script>
</body>
