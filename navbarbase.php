...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
          ...
          <a class="navbar-brand" href="index.php"> <img class =logo alt="Logo" src="resources/downtowntroylogo.jpg"> Downtown Troy  </a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            if(isset($_SESSION['uname']) == "") {
                ...
                echo '<form class="d-flex" action="login.php"><button type="submit" class="btn btn-outline-success">Log In</button></form>';
                echo '<form class="d-flex" action="signup.php"><button type="submit" class="btn btn-outline-success">Sign Up</button></form>';
            } else {
                
                    echo '<form action="direct.php" class="d-flex"><button type="submit" class="btn btn-outline-success">'.$_SESSION['uname']. ' Profile</button></form>';
